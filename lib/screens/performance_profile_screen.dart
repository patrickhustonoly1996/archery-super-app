...
class _PerformanceProfileScreenState extends State<PerformanceProfileScreen> {
  ...
  Widget _buildHeader(SkillsProvider provider) {
    return Container(
      padding: const EdgeInsets.all(16),
      ...
      child: Row(
        children: [
          // RuneScape style total level display
          Container(
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 4),
                Text(
                  '${provider.skills.length} skills tracked',
                  style: TextStyle(
                ...
                _buildTotalProgressBar(provider),
              ],
            ),
          ),
        ],
  ...
  Widget _buildTotalProgressBar(SkillsProvider provider) {
    final maxPossibleLevel = provider.skills.length * 99;
    final progress = maxPossibleLevel > 0
        ? provider.totalLevel / maxPossibleLevel
        : 0.0;
