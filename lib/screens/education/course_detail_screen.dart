    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              Icon(Icons.video_library, size: 16, color: AppColors.textMuted),
            ...
            children: [
              Container(
                ...
                child: Icon(
                  ...
                  color: canWatch ? AppColors.gold : AppColors.textMuted,
                ),
              ),
              const SizedBox(width: 16),
              Expanded(
                  ...
                  children: [
                    Text(
                      ...
                      style: TextStyle(
                        fontFamily: AppFonts.pixel,
                        fontSize: 14,
                        color: canWatch ? AppColors.textPrimary : AppColors.textMuted,
                      ),
                    ),
