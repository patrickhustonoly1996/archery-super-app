...
// Conditional import: use stub on native, real implementation on web
import 'auto_plot_scan_screen_web_stub.dart'
    if (dart.library.js_interop) 'auto_plot_scan_screen_web.dart';
